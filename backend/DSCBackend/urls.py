...
urlpatterns = [
    ...
    path('api/members/', include('backend.members.urls')),
    path('api/team/', include('backend.team.urls')),
    path('api/achievements/', include('backend.achievement.urls')),
    path('api/events/', include('backend.events.urls')),
    path('api/projects/', include('backend.projects.urls')),
