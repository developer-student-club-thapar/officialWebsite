    ...
    const classes = useStyles();
        return (
            ...
            <Container fixed>
                ...
                <Grid item xs={12} sm={6} md={3} lg={6} xl={6} style={{paddingTop:'90px',}}>
                {/* <Paper className={classes.paper}> */}
                    ...
                    <Grid item xs={12} sm={6} md={3} lg={6} xl={6} style={{paddingTop:'90px', paddingLeft:'90px'}}>
                    {/* <Paper className={classes.paper}> */}
                        <Typography variant='h2' style={{textAlign:'left'}}>About Us</Typography>
